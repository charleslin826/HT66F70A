...
{	u8 temp=0b00000001;
	_tm0al=(u8)BITC; _tm0ah=BITC>>8;					//設定計數時間為BITC(1個BIT所需時間)
	_t0af=0;
	_TX=0;												//Start counting 
	_t0on=1;
	while(!_t0af);										//等待時間到之前先空轉 到了才到下一行 
	_t0af=0;											//清掉旗標
	do 
