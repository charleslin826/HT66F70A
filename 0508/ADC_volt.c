// PROGRAM	: ADC_Volt.c													2018.0505
// FUNCTION	: ADC(12-Bit) & LCD Dec/Hex Display with Convert to voltage		By Steven
//		      Explain Program ACD.C in Same Directory First!!!	
#define 	Voltage										//MARK To Display ADC Result
...
{	u8 i;
	...
	_tm2al=4000%256; _tm2ah=4000/256;					// TM2A=4000
...
{	u8 i; u16 temp;
	...
	{	
#ifdef Voltage		
		DisBuffer[4]=1;									//Display P1
#else
		DisBuffer[4]=0;									//P1 Clear
#endif	

#ifdef Decimal
		Digit[0]=Result/1000; temp=Result%1000;			//Decimal Display
...
{	Result=_adrh; Result=(Result<<8)+_adrl;				//Get 12-Bit ADC Result
#ifdef Voltage
	Result=((u32)Result*5*1000)>>12;					//Convert to Voltage
#endif
}
